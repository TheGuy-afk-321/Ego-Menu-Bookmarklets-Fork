javascript: (function() {
  ...
  const egoPS1Emu = document.getElementById("egoPS1Emu");
  
  egoPS1Emu.addEventListener("click", () => {
    const popupContent = `
      <div class="EgoWindowPopoutTitle">PS1</div>
  
      <iframe id="egoPS1EmuFrame" src="https://www.ps1fun.com/" frameborder="0" style="width: 100%;height: 20rem;border-radius: 2vmin;display: block;"></iframe>
      <button id="showPS1Emu" class="EgoMenuButton">Show Page</button>
      <button id="togglePS1EmuFullscreen" class="EgoMenuButton">Full Screen</button>
      <div id="egoPS1ErrorDiv" style="display: none;color: #ff7272;font-weight: bold;padding: 3vmin;font-family: monospace;font-size: 3vmin;">Error: The iframe failed to load.</div>
    `;
    togglePopup(popupContent, true);
  
    const showPS1Emu = document.getElementById("showPS1Emu");
    showPS1Emu.addEventListener("click", () => {
      window.open("https://www.ps1fun.com/", "_blank");
    });
  
    const togglePS1EmuFullscreen = document.getElementById("togglePS1EmuFullscreen");
    const egoPS1EmuFrame = document.getElementById("egoPS1EmuFrame");
    const egoPS1ErrorDiv = document.getElementById("egoPS1ErrorDiv");
  
    togglePS1EmuFullscreen.addEventListener("click", () => {
      if (egoPS1EmuFrame.requestFullscreen) {
        egoPS1EmuFrame.requestFullscreen();
      } else if (egoPS1EmuFrame.mozRequestFullScreen) { 
        egoPS1EmuFrame.mozRequestFullScreen();
      } else if (egoPS1EmuFrame.webkitRequestFullscreen) { 
        egoPS1EmuFrame.webkitRequestFullscreen();
      } else if (egoPS1EmuFrame.msRequestFullscreen) { 
        egoPS1EmuFrame.msRequestFullscreen();
      }
    });
  
    egoPS1EmuFrame.addEventListener("load", () => {
        egoPS1ErrorDiv.style.display = "none";
      egoPS1EmuFrame.style.display = "block";
    });
  
    egoPS1EmuFrame.onerror = () => {
        egoPS1ErrorDiv.style.display = "block";
      egoPS1EmuFrame.style.display = "none";
    };
    
    window.addEventListener("message", (event) => {
      if (event.origin === "https://www.ps1fun.com/") {
        if (event.data === "errorDivVisible") {
            egoPS1ErrorDiv.style.display = "block";
          egoPS1EmuFrame.style.display = "none";
        }
  ...
  const egoSNESEmu = document.getElementById("egoSNESEmu");
  
  egoSNESEmu.addEventListener("click", () => {
    const popupContent = `
      <div class="EgoWindowPopoutTitle">SNES</div>
  
      <iframe id="egoSNESFrame" src="https://supernintendoemulator.com/" frameborder="0" style="width: 100%;height: 20rem;border-radius: 2vmin;display: block;"></iframe>
      <button id="showSNESEmu" class="EgoMenuButton">Show Page</button>
      <button id="toggleSNESFullscreen" class="EgoMenuButton">Full Screen</button>
      <div id="egoSNESErrorDiv" style="display: none;color: #ff7272;font-weight: bold;padding: 3vmin;font-family: monospace;font-size: 3vmin;">Error: The iframe failed to load.</div>
    `;
    togglePopup(popupContent, true);
  
    const showSNESEmu = document.getElementById("showSNESEmu");
    showSNESEmu.addEventListener("click", () => {
      window.open("https://supernintendoemulator.com/", "_blank");
    });
  
    const toggleSNESFullscreen = document.getElementById("toggleSNESFullscreen");
    const egoSNESFrame = document.getElementById("egoSNESFrame");
    const egoSNESErrorDiv = document.getElementById("egoSNESErrorDiv");
  
    toggleSNESFullscreen.addEventListener("click", () => {
      if (egoSNESFrame.requestFullscreen) {
        egoSNESFrame.requestFullscreen();
      } else if (egoSNESFrame.mozRequestFullScreen) { 
        egoSNESFrame.mozRequestFullScreen();
      } else if (egoSNESFrame.webkitRequestFullscreen) { 
        egoSNESFrame.webkitRequestFullscreen();
      } else if (egoSNESFrame.msRequestFullscreen) { 
        egoSNESFrame.msRequestFullscreen();
      }
    });
  
    egoSNESFrame.addEventListener("load", () => {
        egoSNESErrorDiv.style.display = "none";
        egoSNESFrame.style.display = "block";
    });
  
    egoSNESFrame.onerror = () => {
        egoSNESErrorDiv.style.display = "block";
        egoSNESFrame.style.display = "none";
    };
    
    window.addEventListener("message", (event) => {
      if (event.origin === "https://supernintendoemulator.com/") {
        if (event.data === "errorDivVisible") {
            egoSNESErrorDiv.style.display = "block";
            egoSNESFrame.style.display = "none";
        }
